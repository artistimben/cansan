                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <span class="navbar-text">
                            ...
                            <span id="current-time"><?php echo e(now()->format('H:i:s')); ?></span>
                        </span>
                    </li>
                    <li class="nav-item">
            ...
            <nav class="col-md-3 col-lg-2 sidebar">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <hr class="my-3">
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('samples.pending')); ?>">
...
<?php /**PATH C:\xampp\htdocs\cansan\kk-cansan\resources\views/layouts/app.blade.php ENDPATH**/ ?>