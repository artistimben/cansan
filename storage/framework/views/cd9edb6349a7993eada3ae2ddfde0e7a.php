...
<meta name="furnace-id" content="<?php echo e($furnaces->first()->id ?? ''); ?>">
<?php $__env->stopPush(); ?>
        ...
        <div class="col-12 col-md-4 mb-4">
            <div class="card h-100">
                ...
                <div class="card-body p-2">
                    ...
                    <?php $__currentLoopData = $set->furnaces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $furnace): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="d-flex justify-content-between align-items-center p-3 mb-3 border rounded position-relative shadow-sm">
                            ...
                            <?php if($furnaceCount >= 2 && $index > 0): ?>
                                <button type="button" 
                                        ...
                                        onclick="swapFurnaces(<?php echo e($furnacesInSet[$index-1]['id']); ?>, <?php echo e($furnace->id); ?>)"
                                        title="Ocakları Değiştir">
                                    <i class="fas fa-exchange-alt fa-sm"></i>
                                </button>
                            <?php endif; ?>
                            
                            <div class="flex-grow-1 <?php echo e($furnaceCount >= 2 && $index > 0 ? 'ms-4' : ''); ?>">
                                <div class="d-flex align-items-center mb-2">
                                    <strong class="fs-6"><?php echo e($furnace->name); ?></strong>
                                    <span class="badge bg-info ms-2"><?php echo e($furnaceCastingCounts[$furnace->id] ?? 0); ?>. DÖKÜM</span>
                                    <!-- Bilgi Butonu -->
                                    <button type="button" 
                                            class="btn btn-outline-info btn-sm ms-2 rounded-circle" 
                                            style="width: 24px; height: 24px; padding: 0;"
                                            onclick="showFurnaceInfo(<?php echo e($furnace->id); ?>)"
                                            title="Ocak Bilgileri">
                                        <i class="fas fa-info fa-xs"></i>
                                    </button>
                                </div>
                                <div class="small text-muted d-none d-sm-block">
                                    <i class="fas fa-weight-hanging me-1"></i>Kapasite: <?php echo e($furnace->capacity ?? 'N/A'); ?> ton | 
                                    <i class="fas fa-layer-group me-1"></i>Set: <?php echo e($furnace->furnaceSet->name ?? 'N/A'); ?>

                                </div>
                                <div class="small text-muted d-block d-sm-none">
                                    <i class="fas fa-weight-hanging me-1"></i><?php echo e($furnace->capacity ?? 'N/A'); ?>t | 
                                    <i class="fas fa-layer-group me-1"></i><?php echo e($furnace->furnaceSet->name ?? 'N/A'); ?>

                                </div>
                                <div class="small text-info">
                                    <i class="fas fa-fire me-1"></i><?php echo e($furnace->castings->count()); ?> döküm
                            ...
                            <div class="text-end ms-2">
                                <span class="badge fs-6 px-3 py-2
                                    ...
                                    <?php elseif($furnace->status === 'idle'): ?> 
                                        <i class="fas fa-pause me-1"></i>Beklemede
                                    <?php elseif($furnace->status === 'maintenance'): ?> 
                                ...
                                <?php if($furnace->status === 'active'): ?>
                                    <div class="small text-success mt-2 d-flex align-items-center">
                                        ...
                                        <strong><?php echo e($furnace->current_temperature ?? 'N/A'); ?>°C</strong>
                                    </div>
                                    <div class="mt-2">
                                        <button type="button" 
                                                class="btn btn-warning btn-sm" 
                                                onclick="deactivateFurnace(<?php echo e($furnace->id); ?>)"
                                ...
                                <?php else: ?>
                                    <div class="small text-muted mt-2">
                                        ...
                                        <span id="inactive-duration-<?php echo e($furnace->id); ?>">Hesaplanıyor...</span>
                                    </div>
                                    <?php if($furnace->status === 'idle'): ?>
                                        <div class="mt-2">
                                            <button type="button" 
                                                    class="btn btn-success btn-sm" 
                                                    onclick="activateFurnace(<?php echo e($furnace->id); ?>)"
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">
                    ...
                    Tüm Dökümler
                    <span class="badge bg-primary ms-2"><?php echo e($allCastings->total()); ?></span>
                </h5>
            ...
            <div class="card-body p-0">
                ...
                <div class="card-header bg-light">
                    <form method="GET" action="<?php echo e(route('furnaces.index')); ?>">
                        <div class="row">
                            ...
                            <div class="col-6 col-sm-3 col-md-2 mb-3">
                                ...
                                <select name="shift" class="form-select">
                                    ...
                                    <option value="Gündüz" <?php echo e(request('shift') == 'Gündüz' ? 'selected' : ''); ?>>Gündüz</option>
                                    <option value="Gece" <?php echo e(request('shift') == 'Gece' ? 'selected' : ''); ?>>Gece</option>
                                </select>
                            </div>
                ...
                <div class="table-responsive d-none d-lg-block">
                        ...
                        <tbody>
                                <?php $__currentLoopData = $allCastings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $casting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr data-furnace-id="<?php echo e($casting->furnace_id); ?>">
                                    <td>
                                            <div class="d-flex align-items-center">
                                                <?php if($casting->status === 'active'): ?>
                                                    <i class="fas fa-hourglass-half text-warning me-2"></i>
                                                    <span class="badge bg-warning">CHARGING</span>
                                                <?php elseif($casting->status === 'charging'): ?>
                                                ...
                                                <?php elseif($casting->status === 'completed'): ?>
                                                    ...
                                                    <span class="badge bg-success"><?php echo e($totalCastings - $index); ?>. DÖKÜM</span>
                                                <?php elseif($casting->status === 'cancelled'): ?>
                                                    <i class="fas fa-times-circle text-danger me-2"></i>
                                                    <span class="badge bg-danger">İPTAL</span>
                                                <?php else: ?>
                                                    <i class="fas fa-circle text-secondary me-2"></i>
                                                    <span class="badge bg-secondary"><?php echo e($casting->status); ?></span>
                                                <?php endif; ?>
                                            </div>
                                    </td>
                                    <td>
                                        <?php if($casting->status === 'active'): ?>
                                            <div class="d-flex align-items-center">
                                                <select class="form-select form-select-sm me-2" style="width: 180px;" 
                                                        onchange="updateCastingFurnace(<?php echo e($casting->id); ?>, this.value)">
                                                    <?php $__currentLoopData = $furnaces->where('status', 'active'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $furnace): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($furnace->id); ?>" 
                                                                <?php echo e($casting->furnace_id == $furnace->id ? 'selected' : ''); ?>>
                                                            <?php echo e($furnace->name); ?> (<?php echo e($furnaceCastingCounts[$furnace->id] ?? 0); ?>. DÖKÜM)
                                                        </option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                                <span class="badge bg-info"><?php echo e($castingFurnaceSequence[$casting->id] ?? 0); ?>. DÖKÜM</span>
                                            </div>
                                        <?php elseif($casting->status === 'charging'): ?>
                                            <div class="d-flex align-items-center">
                                                <strong class="text-info"><?php echo e($casting->furnace->name); ?> (<?php echo e($furnaceCastingCounts[$casting->furnace_id] ?? 0); ?>. DÖKÜM)</strong>
                                                <span class="badge bg-info ms-2">YENİ DÖKÜM</span>
                                            </div>
                                        <?php else: ?>
                                            <strong><?php echo e($casting->furnace->name); ?> (<?php echo e($castingFurnaceSequence[$casting->id] ?? 0); ?>. DÖKÜM)</strong>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                            <?php if($casting->status === 'charging'): ?>
                                                <strong class="text-info">-</strong>
                                            <?php else: ?>
                                                <strong><?php echo e($casting->started_at ? $casting->started_at->format('H:i') : '-'); ?></strong>
                                            <?php endif; ?>
                                    </td>
                                    <td>
                                            <?php if($casting->status === 'charging'): ?>
                                                <strong class="text-info">-</strong>
                                            <?php else: ?>
                                                <strong><?php echo e($casting->completed_at ? $casting->completed_at->format('H:i') : '---'); ?></strong>
                                            <?php endif; ?>
                                    </td>
                                    <td>
                                            <?php if($casting->status === 'charging'): ?>
                                                <strong class="text-info">-</strong>
                                            <?php elseif($casting->completed_at): ?>
                                                <strong><?php echo e($casting->started_at->diffInMinutes($casting->completed_at)); ?> DK</strong>
                                            <?php elseif($casting->status === 'active'): ?>
                                    ...
                                    <td>
                                            <?php if($casting->status === 'charging'): ?>
                                                <strong class="text-info"><?php echo e($casting->target_temperature ?? '-'); ?>°</strong>
                                            <?php elseif($casting->status === 'active' && $casting->furnace->current_temperature): ?>
                                                <strong class="text-danger"><?php echo e($casting->furnace->current_temperature); ?>°</strong>
                                            <?php elseif($casting->status === 'completed' && $casting->final_temperature): ?>
                                                <strong class="text-success"><?php echo e($casting->final_temperature); ?>°</strong>
                                        <?php else: ?>
                                                <strong>---°</strong>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                            ...
                                            <?php else: ?>
                                                <strong><?php echo e($casting->operator_name ?? '---'); ?></strong>
                                            <?php endif; ?>
                                    </td>
                                    <td>
                                            <?php if($casting->status === 'charging'): ?>
                                            ...
                                            <?php else: ?>
                                                <div class="small">
                                                    <div><strong>SİLİS:</strong> <?php echo e($casting->adjustments->where('material_type', 'silicon')->sum('amount_kg') ?? 0); ?> KG</div>
                                                    <div><strong>MANGAN:</strong> <?php echo e($casting->adjustments->where('material_type', 'manganese')->sum('amount_kg') ?? 0); ?> KG</div>
                                                    <div><strong>KARBON:</strong> <?php echo e($casting->adjustments->where('material_type', 'carbon')->sum('amount_kg') ?? 0); ?> KG</div>
                                                </div>
                                            <?php endif; ?>
                                            <?php if($casting->status !== 'charging'): ?>
                                                <div class="mt-1">
                                                    <button type="button" class="btn btn-xs btn-outline-primary add-alyaj-btn" 
                                                            data-casting-id="<?php echo e($casting->id); ?>" title="Alyaj Ekle">
                                                        <i class="fas fa-plus"></i>
                                                    </button>
                                                    <button type="button" class="btn btn-xs btn-outline-info edit-alyaj-btn" 
                                                            data-casting-id="<?php echo e($casting->id); ?>" title="Alyaj Düzenle">
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <div class="prova-container" data-casting-id="<?php echo e($casting->id); ?>">
                                                    <?php if($casting->samples->count() > 0): ?>
                                                        <?php $__currentLoopData = $casting->samples; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sampleIndex => $sample): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="prova-item mb-2" data-sample-id="<?php echo e($sample->id); ?>">
                                                            <div class="d-flex align-items-center mb-1">
                                                                <strong class="me-2"><?php echo e($sampleIndex + 1); ?>.PROVA:</strong>
                                                                <button class="btn btn-sm btn-outline-primary edit-prova-btn" 
                                                                        data-sample-id="<?php echo e($sample->id); ?>"
                                                                        title="Düzenle">
                                                                    <i class="fas fa-edit"></i>
                                                                </button>
                                                            </div>
                                                            <div class="prova-values">
                                                                <span class="prova-value" data-field="carbon">C:<?php echo e($sample->carbon ?? '---'); ?></span>
                                                                <span class="prova-value" data-field="silicon">Sİ:<?php echo e($sample->silicon ?? '---'); ?></span>
                                                                <span class="prova-value" data-field="manganese">MN:<?php echo e($sample->manganese ?? '---'); ?></span>
                                                                <span class="prova-value" data-field="sulfur">S:<?php echo e($sample->sulfur ?? '---'); ?></span>
                                                                <span class="prova-value" data-field="phosphorus">P:<?php echo e($sample->phosphorus ?? '---'); ?></span>
                                                                <span class="prova-value" data-field="copper">CU:<?php echo e($sample->copper ?? '---'); ?></span>
                                                            </div>
                                                        </div>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php else: ?>
                                    ...
                                    <td>
                                            <?php if($casting->status === 'charging'): ?>
                                                <button type="button" 
                                                        ...
                                                        data-furnace-id="<?php echo e($casting->furnace_id); ?>"
                ...
                <div class="d-block d-lg-none p-3">
                        <?php $__currentLoopData = $allCastings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $casting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="card mb-3" data-furnace-id="<?php echo e($casting->furnace_id); ?>">
                            <div class="card-body">
                                ...
                                <div class="row mb-2">
                                    <div class="col-6">
                                            ...
                                            <?php if($casting->status === 'charging'): ?>
                                                <div><strong class="text-info">-</strong></div>
                                            <?php else: ?>
                                                <div><strong><?php echo e($casting->started_at ? $casting->started_at->format('H:i') : '-'); ?></strong></div>
                                            <?php endif; ?>
                                    </div>
                                    <div class="col-6">
                                            ...
                                            <?php if($casting->status === 'charging'): ?>
                                                <div><strong class="text-info">-</strong></div>
                                            <?php else: ?>
                                                <div><strong><?php echo e($casting->completed_at ? $casting->completed_at->format('H:i') : '---'); ?></strong></div>
                                            <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-2">
                                    <div class="col-6">
                                            <small class="text-muted">TTT:</small>
                                        <div>
                                                <?php if($casting->status === 'charging'): ?>
                                                    <strong class="text-info">-</strong>
                                                <?php elseif($casting->completed_at): ?>
                                    ...
                                    <div class="col-6">
                                            <small class="text-muted">DEVİRME SICAKLIĞI:</small>
                                            <div>
                                                <?php if($casting->status === 'charging'): ?>
                                                    <strong class="text-info"><?php echo e($casting->target_temperature ?? '-'); ?>°</strong>
                                                <?php elseif($casting->status === 'active' && $casting->furnace->current_temperature): ?>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-12">
                                            <small class="text-muted">OCAK FORMENİ:</small>
                                            <?php if($casting->status === 'charging'): ?>
                                                <div><strong class="text-info">Sistem</strong></div>
                                            <?php else: ?>
                                                <div><strong><?php echo e($casting->operator_name ?? '---'); ?></strong></div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-12">
                                            <small class="text-muted">KULLANILAN ALYAJ:</small>
                                            <?php if($casting->status === 'charging'): ?>
                                                <div class="small text-info">
                                                    <div><strong>SİLİS:</strong> 0 KG</div>
                                                    <div><strong>MANGAN:</strong> 0 KG</div>
                                            ...
                                            <?php if($casting->status !== 'charging'): ?>
                                                <div class="mt-2">
                                                    <button type="button" class="btn btn-sm btn-outline-primary add-alyaj-btn" 
                                                            data-casting-id="<?php echo e($casting->id); ?>" title="Alyaj Ekle">
                                                        <i class="fas fa-plus"></i> Alyaj Ekle
                                                    </button>
                                                    <button type="button" class="btn btn-sm btn-outline-info edit-alyaj-btn" 
                                                            data-casting-id="<?php echo e($casting->id); ?>" title="Alyaj Düzenle">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            <small class="text-muted">ANALİZLER:</small>
                                            <?php if($casting->status === 'charging'): ?>
                                                <div class="text-info">
                                                    <small>Yeni döküm için hazır</small>
                                                </div>
                                    ...
                                    <div class="d-flex gap-2">
                                        <?php if($casting->status === 'charging'): ?>
                                            <button type="button" 
                                                    class="btn btn-sm btn-outline-info start-casting flex-fill" 
                                                    data-furnace-id="<?php echo e($casting->furnace_id); ?>">
                                                <i class="fas fa-play"></i> Yeni Döküm
                                            </button>
                                        <?php elseif($casting->status === 'active'): ?>
                                            <button type="button" 
                                            ...
                                            <button type="button" 
                                                    class="btn btn-sm btn-outline-danger cancel-casting flex-fill" 
                                                    data-casting-id="<?php echo e($casting->id); ?>">
                                        ...
                                        <?php if($casting->status !== 'charging'): ?>
                                            <button type="button" 
                                                    class="btn btn-sm btn-outline-info add-prova-btn flex-fill" 
                                                    data-casting-id="<?php echo e($casting->id); ?>">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row" id="furnace-selection-cards">
                    <?php $__currentLoopData = $furnaces->where('status', 'idle')->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $furnace): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-4 mb-3">
                            <div class="card furnace-selection-card h-100" data-furnace-id="<?php echo e($furnace->id); ?>" style="cursor: pointer;">
                                <div class="card-body text-center">
                                    <div class="mb-3">
                                        <i class="fas fa-fire fa-3x text-primary"></i>
                                    </div>
                                    <h5 class="card-title"><?php echo e($furnace->name); ?></h5>
                                    <p class="card-text text-muted"><?php echo e($furnace->furnaceSet->name ?? 'N/A'); ?></p>
                                    <div class="casting-count-display">
                                        <span class="badge bg-primary fs-6">
                                            <?php echo e($furnaceCastingCounts[$furnace->id] ?? 0); ?>. DÖKÜM
                                        </span>
                                    </div>
                                    <div class="mt-2">
                                        <small class="text-muted">Kapasite: <?php echo e($furnace->capacity ?? 'N/A'); ?> ton</small>
                                    </div>
                                </div>
                            </div>
                        </div>
