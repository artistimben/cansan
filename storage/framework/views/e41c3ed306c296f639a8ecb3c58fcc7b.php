...
<?php $__env->startSection('title', 'Raporlar - Cansan Kalite Kontrol'); ?>
            ...
            <div class="modal-body">
                <form id="reportSettingsForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="reportDate" value="<?php echo e(date('Y-m-d')); ?>">
                    </div>
                    <div class="mb-3">
...
function exportReport(type) {
    ...
    const url = `<?php echo e(route('reports.export')); ?>?type=${type}&date=${today}`;
...
document.addEventListener('keydown', function(e) {
    ...
    if (e.ctrlKey && e.key === '1') {
        e.preventDefault();
        window.location.href = '<?php echo e(route("reports.daily")); ?>';
    }
    
    // Ctrl + 2: Haftalık rapor
    if (e.ctrlKey && e.key === '2') {
        e.preventDefault();
        window.location.href = '<?php echo e(route("reports.weekly")); ?>';
    }
    
    // Ctrl + 3: Aylık rapor
    if (e.ctrlKey && e.key === '3') {
        e.preventDefault();
        window.location.href = '<?php echo e(route("reports.monthly")); ?>';
    }
});
</script>
<?php $__env->stopPush(); ?>
