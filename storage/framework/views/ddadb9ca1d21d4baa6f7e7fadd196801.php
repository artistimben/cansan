...
<?php $__env->startSection('title', 'Bekleyen Provalar - Cansan Kalite Kontrol'); ?>

<?php $__env->startSection('header', 'Bekleyen Provalar'); ?>

<?php $__env->startSection('header-buttons'); ?>
    <div class="btn-group" role="group">
        <a href="<?php echo e(route('samples.index')); ?>" class="btn btn-outline-secondary btn-sm">
    ...
    <div class="col-md-4">
        <div class="card text-center bg-warning text-white">
            <div class="card-body">
                ...
                <h3 class="mb-1"><?php echo e($samples->count()); ?></h3>
    ...
    <div class="col-md-4">
        <div class="card text-center bg-info text-white">
            <div class="card-body">
                ...
                <h3 class="mb-1"><?php echo e($samples->where('sample_time', '<', now()->subHours(2))->count()); ?></h3>
    ...
    <div class="col-md-4">
        <div class="card text-center bg-danger text-white">
            <div class="card-body">
                ...
                <h3 class="mb-1"><?php echo e($samples->where('sample_time', '<', now()->subHours(4))->count()); ?></h3>
            ...
            <div class="card-body">
                <?php if($samples->count() > 0): ?>
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $samples->sortBy('sample_time'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sample): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    <tr class="<?php echo e($rowClass); ?>">
                                        <td>
                                            <input type="checkbox" class="form-check-input sample-checkbox" value="<?php echo e($sample->id); ?>" onchange="updateBulkActions()">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <?php if($waitingHours >= 4): ?>
                                                <span class="badge bg-danger"><?php echo e($waitingHours); ?> saat</span>
                                            <?php elseif($waitingHours >= 2): ?>
                                                <span class="badge bg-warning"><?php echo e($waitingHours); ?> saat</span>
                                            <?php else: ?>
                                                <span class="badge bg-info"><?php echo e($waitingHours); ?> saat</span>
                                            <?php endif; ?>
                                            <br><small class="text-muted"><?php echo e($sample->sample_time->diffForHumans()); ?></small>
                                        </td>
                                        <td><?php echo e($sample->analyzed_by); ?></td>
                                        <td>
                                            <small>
                                                <?php if($sample->carbon_percentage): ?>
                                                    <div>C: <?php echo e(number_format($sample->carbon_percentage, 3)); ?>%</div>
                                                <?php endif; ?>
                                                <?php if($sample->manganese_percentage): ?>
                                                    <div>Mn: <?php echo e(number_format($sample->manganese_percentage, 3)); ?>%</div>
                                                <?php endif; ?>
                                                <?php if($sample->silicon_percentage): ?>
                                                    <div>Si: <?php echo e(number_format($sample->silicon_percentage, 3)); ?>%</div>
                                                <?php endif; ?>
                                                <?php if(!$sample->carbon_percentage && !$sample->manganese_percentage && !$sample->silicon_percentage): ?>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm" role="group">
                                                <button type="button" class="btn btn-success btn-sm" onclick="quickApprove(<?php echo e($sample->id); ?>)" title="Hızlı Onayla">
                                                    <i class="fas fa-check"></i>
                                                </button>
                                                <button type="button" class="btn btn-danger btn-sm" onclick="quickReject(<?php echo e($sample->id); ?>)" title="Hızlı Reddet">
                                                    <i class="fas fa-times"></i>
                                                </button>
                                                <button type="button" class="btn btn-info btn-sm" onclick="needsAdjustment(<?php echo e($sample->id); ?>)" title="Düzeltme Gerekli">
                                                    <i class="fas fa-tools"></i>
                                                </button>
                                                <a href="<?php echo e(route('samples.show', $sample)); ?>" class="btn btn-outline-primary btn-sm" title="Detay">
                ...
                <?php else: ?>
                    <div class="text-center text-muted py-5">
                        ...
                        <a href="<?php echo e(route('samples.index')); ?>" class="btn btn-primary">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cansan\kk-cansan\resources\views/samples/pending.blade.php ENDPATH**/ ?>