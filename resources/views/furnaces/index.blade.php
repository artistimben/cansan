                                ...
                                <tr>
                                    <td>
                                        ...
                                        @if($furnace->description)
                                            <br><small class="text-muted">{{ $furnace->description }}</small>
                                        @endif
                                    </td>
                                    <td>
                                        <span class="badge bg-primary">{{ $furnace->furnaceSet->name }}</span>
                                    </td>
                                    <td>
                                        <span class="badge 
                                            @if($furnace->status === 'active') bg-success
                                        ...
                                        @if($furnace->status_updated_at)
                                            <br><small class="text-muted">{{ $furnace->status_updated_at->diffForHumans() }}</small>
                                        @endif
                                    </td>
                                    <td>
                                        {{ $furnace->capacity ?? 'N/A' }} ton
                                        @if($furnace->max_temperature)
                                            <br><small class="text-muted">Max: {{ $furnace->max_temperature }}°C</small>
                                        @endif
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group">
                                            <a href="{{ route('furnaces.show', $furnace) }}" class="btn btn-outline-info btn-sm" title="Detay">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('furnaces.edit', $furnace) }}" class="btn btn-outline-primary btn-sm" title="Düzenle">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            @if($furnace->status !== 'active')
                                                <button type="button" class="btn btn-outline-success btn-sm" onclick="updateFurnaceStatus({{ $furnace->id }}, 'active')" title="Aktif Yap">
                                                    <i class="fas fa-play"></i>
                                                </button>
                                            @else
                                                <button type="button" class="btn btn-outline-warning btn-sm" onclick="updateFurnaceStatus({{ $furnace->id }}, 'idle')" title="Bekletmeye Al">
                                            ...
                                            <div class="btn-group btn-group-sm">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item" href="{{ route('castings.index', ['furnace_id' => $furnace->id]) }}">
                                                        <i class="fas fa-fire me-2"></i>Dökümleri Görüntüle
                                                    </a></li>
                                                    <li><a class="dropdown-item" href="{{ route('samples.index', ['furnace_id' => $furnace->id]) }}">
                                                        <i class="fas fa-vial me-2"></i>Provalarını Görüntüle
                                                    </a></li>
                                                    <li><hr class="dropdown-divider"></li>
                                                    <li><a class="dropdown-item" href="#" onclick="updateFurnaceStatus({{ $furnace->id }}, 'maintenance')">
                                                        <i class="fas fa-tools me-2"></i>Bakıma Al
                                                    </a></li>
                                                    <li><a class="dropdown-item" href="#" onclick="updateFurnaceStatus({{ $furnace->id }}, 'inactive')">
