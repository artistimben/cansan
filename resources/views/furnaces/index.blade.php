                ...
                @else
                                ...
                                <div class="row mb-2">
                                    <div class="col-6">
                                            ...
                                            @else
                                                <div><strong>{{ $casting->started_at ? $casting->started_at->format('H:i') : '-' }}</strong></div>
                                            @endif
                                    </div>
                                    <div class="col-6">
                                            ...
                                            @if($casting->status === 'charging')
                                                <div><strong class="text-info">-</strong></div>
                                            @else
                                                <div><strong>{{ $casting->completed_at ? $casting->completed_at->format('H:i') : '---' }}</strong></div>
                                            @endif
                                    </div>
                                </div>
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-12">
                                            ...
                                            @else
                                                <div><strong>{{ $casting->operator_name ?? '---' }}</strong></div>
                                            @endif
                                        </div>
                                    </div>
